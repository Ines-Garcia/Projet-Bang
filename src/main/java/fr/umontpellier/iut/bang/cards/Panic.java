...
public class Panic extends OrangeCard {
    ...
    public void playedBy(Player player) {
        ...
        if (player.choose("Voulez vous prendre une carte en jeu", choice, true, false).equals("")) {  //si il prend une carte en main
            ...
            Card bleuCardPicked = playerCible.chooseBlueCard("Séléctionne une carte en jeu carte", playerCible.getInPlay(), true, false);
